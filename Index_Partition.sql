...
CREATE NONCLUSTERED INDEX IX_MaChiNhanh ON PhieuDatMon (MaChiNhanh)
INCLUDE (NgayLap, IDNhanVien);
GO 
...
CREATE NONCLUSTERED INDEX IX_ChiTietPhieu_MaPhieu
ON ChiTietPhieuDat (MaPhieu);
GO
...
ADD FILE(NAME = 'HD2020', FILENAME = 'D:\User\Duy\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\P1.mdf', SIZE = 2, MAXSIZE = 100, FILEGROWTH = 2) TO FILEGROUP HD2020;
ALTER DATABASE RES_ADB
ADD FILE(NAME = 'HD2021', FILENAME = 'D:\User\Duy\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\P2.mdf', SIZE = 2, MAXSIZE = 100, FILEGROWTH = 2) TO FILEGROUP HD2021;
ALTER DATABASE RES_ADB
ADD FILE(NAME = 'HD2022', FILENAME = 'D:\User\Duy\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\P3.mdf', SIZE = 2, MAXSIZE = 100, FILEGROWTH = 2) TO FILEGROUP HD2022;
ALTER DATABASE RES_ADB
ADD FILE(NAME = 'HD2023', FILENAME = 'D:\User\Duy\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\P4.mdf', SIZE = 2, MAXSIZE = 100, FILEGROWTH = 2) TO FILEGROUP HD2023;
...
GO
ALTER TABLE HoaDon DROP CONSTRAINT PK__HoaDon__835ED13B6393626A
